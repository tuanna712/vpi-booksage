...
class BookQA:
    def __init__(self, 
        ...
        openai_api_key = "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"
    ...
    def prompting(self):
        ...
        if self.llm == 'palm2' and self.book_lang == 'vi':
            os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/lakehouse/default/Files/DevBookSage/assets/authentication/ambient-hulling-389607-89c372b7af63.json'
    ...
    def responding_openai(self):
        ...
        if prompt_token_length > 16000:
            ...
            response = openai.ChatCompletion.create(
                    ...
                    messages=[{"role": "system", "content": "You are a helpful assistant that gives a comprehensive answer in Vietnamese from the given information"},
